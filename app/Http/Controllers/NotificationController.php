...
class NotificationController extends Controller
{
    ...
    {
        return view('auth.notifications.index')->with('notifications', Notification::all());
    }
    ...
    public function update(Request $request, Notification $notification)
    {
        ...
        if ($request->hasFile('notification_file')) {
            //store new image
            $notification_file = $request->notification_file = $request->file('notification_file')->store('');
            //delete old image
            //deleteImage()defined in model
            $notification_file->deleteFile();

            $data['notification_file'] = $notification_file;
        }

        //storing attribute
        $notification_file->update($data);
        //flashing session
