<form method="POST" action="{{  isset($etender) ? route('etenders.update', $etender->id) : route('etenders.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="{{ isset($etender) ? $etender->title : old('title') }}" class="form-control input-default @error('title') is-invalid @enderror"  autocomplete="title" autofocus />
