<form method="POST" action="{{  isset($activity) ? route('activities.update', $activity->id) : route('activities.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="{{ isset($activity) ? $activity->title : old('title') }}" class="form-control input-default @error('title') is-invalid @enderror"  autocomplete="title" autofocus />
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description"  class="form-control input-default @error('description') is-invalid @enderror"  autofocus />{{ isset($activity) ? $activity->description : old('description') }}</textarea>
